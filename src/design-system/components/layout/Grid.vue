...
const classes = computed(() =>
  ["ds-grid", `ds-grid--cols-${props.columns}`, `ds-grid--gap-${props.gap}`].join(" ")
);
</script>
...
.ds-grid--gap-0 { gap: var(--spacing-0); }
.ds-grid--gap-1 { gap: var(--spacing-1); }
.ds-grid--gap-2 { gap: var(--spacing-2); }
.ds-grid--gap-3 { gap: var(--spacing-3); }
.ds-grid--gap-4 { gap: var(--spacing-4); }
.ds-grid--gap-5 { gap: var(--spacing-5); }
.ds-grid--gap-6 { gap: var(--spacing-6); }
.ds-grid--gap-8 { gap: var(--spacing-8); }
.ds-grid--gap-10 { gap: var(--spacing-10); }
.ds-grid--gap-12 { gap: var(--spacing-12); }
</style>
